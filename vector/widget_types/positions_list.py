...
class _PositionRow(QFrame):
    def __init__(self, pos: dict, fmt_currency, fmt_pct, parent=None) -> None:
        ...
        name_lbl.setStyleSheet(f'font-size: {scpt(11)}pt; border: none;')
        name_lbl.setMaximumWidth(sc(130))
        name_lbl.setTextFormat(Qt.TextFormat.PlainText)
        fm = name_lbl.fontMetrics()
        elided = fm.elidedText(name_lbl.text(), Qt.TextElideMode.ElideRight, sc(130))
        ...
        shares_lbl.setStyleSheet(f'font-size: {scpt(11)}pt; border: none;')
        ...
        price_lbl.setStyleSheet(f'font-size: {scpt(12)}pt; border: none;')
        ...
        equity_font = QFont()
        equity_font.setPointSize(scpt(12))
        equity_font.setBold(True)
        equity_lbl.setFont(equity_font)
        equity_lbl.setStyleSheet(f'font-size: {scpt(12)}pt; border: none;')
...
class PositionsListWidget(VectorWidget):
    ...
    def __init__(self, window=None, parent=None) -> None:
        ...
        self._count_lbl.setStyleSheet(f'font-size: {scpt(11)}pt; border: none;')
