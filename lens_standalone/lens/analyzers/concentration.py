...
def analyze(
    ...
    for pos in positions:
        ...
        # Winner drift requires the position to actually be UP from cost —
        # otherwise a holding that merely fell less than its peers (current weight
        # > cost-basis weight) gets mislabeled a "winner that drifted".
